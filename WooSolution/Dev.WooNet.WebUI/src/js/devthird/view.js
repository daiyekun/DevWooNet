...
function cleardata(){
    ...
    function closeWin() {
        if ($devId > 0) {
            top.winui.window.close('win_viewthird');
        } else {
    ...
    function devSetValues() {
        ...
        if ($devId !== "" && $devId !== undefined) {
            wooutil.devajax({
                type: 'GET',
                url: devsetter.devbaseurl + 'api/DevThird/showView',
                //async: false,
                data: { Id: $devId },
                dataType: 'json',
                success: function (res) {
...
/***********************备忘录-end***************************************************************************************************/
                    ...
                    case 'Account':
                        ...
                        {//都是文本编辑框
                            devviewedit.render({
                                ...
                                verify: 'required',
                                ckEl: '#Name',
                                url: devsetter.devbaseurl +'api/ DevThird/UpdateField'
 ...
 secfield();
//审批历史
 flowapplist.applistInit({ Id: $devId, objType: 2 });
 /******************************************************审批按钮begin*******************************************/

 appflowdata=flowapplist.getappflowinfo({ AppObjId: $devId, ObjType: 2 ,CurrUserId:0});
 ...
 $("#Dev-AppSavebtn").on("click",function(){//审批按钮
    var optiondata={};
    optiondata.prefix="third";//前缀
    optiondata.objtype=2;//审批类型
